...
static const yytype_uint8 yyrline[] =
{
     ...
     124,   125,   129,   130,   133,   134,   138,   143,   144,   147,
     148,   151,   152,   155,   160,   162,   163,   166,   167,   168,
     169,   170,   171,   172,   176,   177,   180,   184,   185,   188,
     189,   194,   195,   196,   197,   198,   200,   201,   202,   203,
     205,   206,   207,   208,   209,   210,   211,   213,   215,   216,
...
static const yytype_int16 yytable[] =
{
      ...
      19,   102,    79,   103,    29,     1,    81,   -15,     2,   105,
...
#line 118 "parser.y"
           {(yyval.nExtDecList)=new NExtDecList(*(yyvsp[0].nVarDec), nullptr); (yyval.nExtDecList)->line=yylineno;}
#line 1429 "parser.cpp"
    break;

  case 9: /* ExtDecList: VarDec COMMA ExtDecList  */
#line 119 "parser.y"
                              {(yyval.nExtDecList)=new NExtDecList(*(yyvsp[-2].nVarDec), (yyvsp[0].nExtDecList)); (yyval.nExtDecList)->line=yylineno;}
...
#line 129 "parser.y"
                                {(yyval.nStructSpecifier)=new NStructSpecifier((yyvsp[-3].nIdentifier), (yyvsp[-1].nDefList)); (yyval.nStructSpecifier)->line=(yyvsp[-4].line); (yyvsp[-3].nIdentifier)->line=(yyvsp[-4].line);}
#line 1453 "parser.cpp"
    break;

  case 13: /* StructSpecifier: STRUCT Tag  */
#line 130 "parser.y"
                 {(yyval.nStructSpecifier)=new NStructSpecifier((yyvsp[0].nIdentifier)); (yyval.nStructSpecifier)->line=(yyvsp[-1].line); (yyvsp[0].nIdentifier)->line=(yyvsp[-1].line);}
...
#line 1465 "parser.cpp"
  ...
  case 15: /* OptTag: ID  */
#line 134 "parser.y"
        {(yyval.nIdentifier)=new NIdentifier(*(new std::string((yyvsp[0].type_id)))); (yyval.nIdentifier)->type="OptTag";}
#line 1471 "parser.cpp"
    break;

  case 16: /* Tag: ID  */
#line 138 "parser.y"
       {(yyval.nIdentifier)=new NIdentifier(*(new std::string((yyvsp[0].type_id)))); (yyval.nIdentifier)->type="Tag";}
#line 1477 "parser.cpp"
    break;

  case 17: /* VarDec: ID  */
#line 143 "parser.y"
       {(yyval.nVarDec)=new NVarDec(*(new NIdentifier(*(new std::string((yyvsp[0].type_id)))))); (yyval.nVarDec)->line=yylineno;}
#line 1483 "parser.cpp"
    break;

  case 18: /* VarDec: VarDec LB INT RB  */
#line 144 "parser.y"
                       {(yyval.nVarDec)=new NVarDec(*(yyvsp[-3].nVarDec)); (yyval.nVarDec)->line=yylineno;}
...
#line 151 "parser.y"
             {(yyval.nVarList)=new NVarList(*(yyvsp[0].nParamDec), nullptr); (yyval.nVarList)->line=yylineno;}
#line 1507 "parser.cpp"
    break;

  case 22: /* VarList: ParamDec COMMA VarList  */
#line 152 "parser.y"
                             {(yyval.nVarList)=new NVarList(*(yyvsp[-2].nParamDec), (yyvsp[0].nVarList)); (yyval.nVarList)->line=yylineno;}
#line 1513 "parser.cpp"
    break;

  case 23: /* ParamDec: Specifier VarDec  */
#line 155 "parser.y"
                     {(yyval.nParamDec)=new NParamDec(*(yyvsp[-1].nSpecifier), *(yyvsp[0].nVarDec)); (yyval.nParamDec)->line=yylineno;}
...
#line 169 "parser.y"
                                                {(yyval.nStmt)=new NIfStmt(*(yyvsp[-2].nExpression), *(yyvsp[0].nStmt)); (yyval.nStmt)->line=yylineno;}
#line 1561 "parser.cpp"
    break;

  case 31: /* Stmt: IF LP Exp RP Stmt ELSE Stmt  */
#line 170 "parser.y"
                                  {(yyval.nStmt)=new NIfElseStmt(*(yyvsp[-4].nExpression), *(yyvsp[-2].nStmt), *(yyvsp[0].nStmt)); (yyval.nStmt)->line=yylineno;}
#line 1567 "parser.cpp"
    break;

  case 32: /* Stmt: WHILE LP Exp RP Stmt  */
#line 171 "parser.y"
                           {(yyval.nStmt)=new NWhileStmt(*(yyvsp[-2].nExpression), *(yyvsp[0].nStmt)); (yyval.nStmt)->line=yylineno;}
...
#line 180 "parser.y"
                           {(yyval.nDef)=new NDef(*(yyvsp[-2].nSpecifier), (yyvsp[-1].nDecList)); (yyval.nDef)->line=yylineno;}
#line 1597 "parser.cpp"
    break;

  case 37: /* DecList: Dec  */
#line 184 "parser.y"
         {(yyval.nDecList)=new NDecList(*(yyvsp[0].nDec), nullptr); (yyval.nDecList)->line=yylineno;}
#line 1603 "parser.cpp"
    break;

  case 38: /* DecList: Dec COMMA DecList  */
#line 185 "parser.y"
                         {(yyval.nDecList)=new NDecList(*(yyvsp[-2].nDec), (yyvsp[0].nDecList)); (yyval.nDecList)->line=yylineno;}
#line 1609 "parser.cpp"
    break;

  case 39: /* Dec: VarDec  */
#line 188 "parser.y"
            {(yyval.nDec)=new NDec(*(yyvsp[0].nVarDec)); (yyval.nDec)->line=yylineno;}
#line 1615 "parser.cpp"
    break;

  case 40: /* Dec: VarDec ASSIGNOP Exp  */
#line 189 "parser.y"
                           {(yyval.nDec)=new NDec(*(yyvsp[-2].nVarDec), (yyvsp[0].nExpression)); (yyval.nDec)->line=yylineno;}
#line 1621 "parser.cpp"
    break;

  case 41: /* Exp: Exp ASSIGNOP Exp  */
#line 194 "parser.y"
                     {(yyval.nExpression)=new NAssignment(*(new std::string("ASSIGNOP")), *(yyvsp[-2].nExpression), (yyvsp[-1].line), *(yyvsp[0].nExpression)); (yyval.nExpression)->line=yylineno;}
#line 1627 "parser.cpp"
    break;

  case 42: /* Exp: Exp PLUSASS Exp  */
#line 195 "parser.y"
                        {(yyval.nExpression)=new NAssignment(*(new std::string("PLUSASS")), *(yyvsp[-2].nExpression), (yyvsp[-1].line), *(yyvsp[0].nExpression)); (yyval.nExpression)->line=yylineno;}
#line 1633 "parser.cpp"
    break;

  case 43: /* Exp: Exp MINUSASS Exp  */
#line 196 "parser.y"
                         {(yyval.nExpression)=new NAssignment(*(new std::string("MINUASS")), *(yyvsp[-2].nExpression), (yyvsp[-1].line), *(yyvsp[0].nExpression)); (yyval.nExpression)->line=yylineno;}
#line 1639 "parser.cpp"
    break;

  case 44: /* Exp: Exp STARASS Exp  */
#line 197 "parser.y"
                        {(yyval.nExpression)=new NAssignment(*(new std::string("STARASS")), *(yyvsp[-2].nExpression), (yyvsp[-1].line), *(yyvsp[0].nExpression)); (yyval.nExpression)->line=yylineno;}
#line 1645 "parser.cpp"
    break;

  case 45: /* Exp: Exp DIVASS Exp  */
#line 198 "parser.y"
                       {(yyval.nExpression)=new NAssignment(*(new std::string("DIVASS")), *(yyvsp[-2].nExpression), (yyvsp[-1].line), *(yyvsp[0].nExpression)); (yyval.nExpression)->line=yylineno;}
#line 1651 "parser.cpp"
    break;

  case 46: /* Exp: PLUSPLUS Exp  */
#line 200 "parser.y"
                                     {(yyval.nExpression)=new NSingleOperator(*(new std::string("PLUSPLUS")), (yyvsp[-1].line), *(yyvsp[0].nExpression)); (yyval.nExpression)->line=yylineno;}
#line 1657 "parser.cpp"
    break;

  case 47: /* Exp: MINUSMINUS Exp  */
#line 201 "parser.y"
                                         {(yyval.nExpression)=new NSingleOperator(*(new std::string("MINUSMINUS")), (yyvsp[-1].line), *(yyvsp[0].nExpression)); (yyval.nExpression)->line=yylineno;}
#line 1663 "parser.cpp"
    break;

  case 48: /* Exp: Exp PLUSPLUS  */
#line 202 "parser.y"
                     {(yyval.nExpression)=new NSingleOperator(*(new std::string("PLUSPLUS")), (yyvsp[0].line), *(yyvsp[-1].nExpression)); (yyval.nExpression)->line=yylineno;}
#line 1669 "parser.cpp"
    break;

  case 49: /* Exp: Exp MINUSMINUS  */
#line 203 "parser.y"
                      {(yyval.nExpression)=new NSingleOperator(*(new std::string("MINUSMINUS")), (yyvsp[0].line), *(yyvsp[-1].nExpression)); (yyval.nExpression)->line=yylineno;}
#line 1675 "parser.cpp"
    break;

  case 50: /* Exp: Exp AND Exp  */
#line 205 "parser.y"
                    {(yyval.nExpression)=new NAssignment(*(new std::string("AND")), *(yyvsp[-2].nExpression), (yyvsp[-1].line), *(yyvsp[0].nExpression)); (yyval.nExpression)->line=yylineno;}
#line 1681 "parser.cpp"
    break;

  case 51: /* Exp: Exp OR Exp  */
#line 206 "parser.y"
                    {(yyval.nExpression)=new NAssignment(*(new std::string("OR")), *(yyvsp[-2].nExpression), (yyvsp[-1].line), *(yyvsp[0].nExpression)); (yyval.nExpression)->line=yylineno;}
#line 1687 "parser.cpp"
    break;

  case 52: /* Exp: Exp RELOP Exp  */
#line 207 "parser.y"
                    {(yyval.nExpression)=new NAssignment(*(new std::string("RELOP")), *(yyvsp[-2].nExpression), RELOP, *(yyvsp[0].nExpression)); (yyval.nExpression)->line=yylineno;}
#line 1693 "parser.cpp"
    break;

  case 53: /* Exp: Exp PLUS Exp  */
#line 208 "parser.y"
                    {(yyval.nExpression)=new NAssignment(*(new std::string("PLUS")), *(yyvsp[-2].nExpression), (yyvsp[-1].line), *(yyvsp[0].nExpression)); (yyval.nExpression)->line=yylineno;}
#line 1699 "parser.cpp"
    break;

  case 54: /* Exp: Exp MINUS Exp  */
#line 209 "parser.y"
                    {(yyval.nExpression)=new NAssignment(*(new std::string("MINUS")), *(yyvsp[-2].nExpression), (yyvsp[-1].line), *(yyvsp[0].nExpression)); (yyval.nExpression)->line=yylineno;}
#line 1705 "parser.cpp"
    break;

  case 55: /* Exp: Exp STAR Exp  */
#line 210 "parser.y"
                    {(yyval.nExpression)=new NAssignment(*(new std::string("STAR")), *(yyvsp[-2].nExpression), (yyvsp[-1].line), *(yyvsp[0].nExpression)); (yyval.nExpression)->line=yylineno;}
#line 1711 "parser.cpp"
    break;

  case 56: /* Exp: Exp DIV Exp  */
#line 211 "parser.y"
                    {(yyval.nExpression)=new NAssignment(*(new std::string("DIV")), *(yyvsp[-2].nExpression), (yyvsp[-1].line), *(yyvsp[0].nExpression)); (yyval.nExpression)->line=yylineno;}
#line 1717 "parser.cpp"
    break;

  case 57: /* Exp: Exp MOD Exp  */
#line 213 "parser.y"
                    {(yyval.nExpression)=new NAssignment(*(new std::string("MOD")), *(yyvsp[-2].nExpression), (yyvsp[-1].line), *(yyvsp[0].nExpression)); (yyval.nExpression)->line=yylineno;}
...
#line 216 "parser.y"
                               {(yyval.nExpression)=new NSingleOperator(*(new std::string("MINUS")), (yyvsp[-1].line), *(yyvsp[0].nExpression)); (yyval.nExpression)->line=yylineno;}
#line 1735 "parser.cpp"
    break;

  case 60: /* Exp: NOT Exp  */
#line 217 "parser.y"
                    {(yyval.nExpression)=new NSingleOperator(*(new std::string("NOT")), (yyvsp[-1].line), *(yyvsp[0].nExpression)); (yyval.nExpression)->line=yylineno;}
