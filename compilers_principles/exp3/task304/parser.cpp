...
#line 125 "parser.y"
                      {(yyval.nSpecifier)=new NSpecifier(); (yyval.nSpecifier)->line=yylineno;}
#line 1447 "parser.cpp"
    break;

  case 12: /* StructSpecifier: STRUCT OptTag LC DefList RC  */
#line 129 "parser.y"
                                {(yyval.nStructSpecifier)=new NStructSpecifier((yyvsp[-3].nIdentifier), (yyvsp[-1].nDefList)); (yyval.nStructSpecifier)->line=yylineno;}
#line 1453 "parser.cpp"
    break;

  case 13: /* StructSpecifier: STRUCT Tag  */
#line 130 "parser.y"
                 {(yyval.nStructSpecifier)=new NStructSpecifier((yyvsp[0].nIdentifier)); (yyval.nStructSpecifier)->line=yylineno;}
